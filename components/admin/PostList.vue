<template>
    <div>
        ...
        <article v-for="(post, index) in posts" :key="post.id">
            ...
            <div class="btn-group">
                <a href="javascript:;" class="btn btn-small btn-danger" @click="updateStatus(index,'offline')" v-if="post.status == 'published'">Xuất bản</a>
                <a href="javascript:;" class="btn btn-small btn-danger" @click="updateStatus(index,'published')" v-if="post.status == 'offline'">Tái xuất bản</a>
                <a href="javascript:;" class="btn btn-small btn-danger" @click="updateStatus(index,'published')" v-if="post.status == 'draft'">Chính thức phát hành</a>
                <nuxt-link target="_blank" class="btn btn-small btn-main" :to="'/blog/'+post.slug+'.html'">Xem trước</nuxt-link>
            </div>
        </article>
