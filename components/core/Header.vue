<template>
  <div class="navbar">
    ...
    <core-breadcrumb class="breadcrumb-container" />
...
import CoreHamburger from '~/components/core/Hamburger.vue'
import CoreBreadcrumb from '~/components/core/Breadcrumb.vue'
export default {
   components: {
    CoreHamburger,
    CoreBreadcrumb
