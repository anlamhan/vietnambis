<template>
  <div id="app" class="container">
    ...
    <div class="title">
        <h1>Danh sách công ty thành lập ngày {{this.date}}</h1>
    </div>
  ...
  <vue-page :total="count" :page="page" :path="`/vn/doanh-nghiep/${date}/`" model="link"></vue-page>
  </div>
</template>
<script>
...
export default {  
 ...
 async asyncData({ params, error }) {            
  ...
  head() {
    return {
       title: 'Danh sách công ty thành lập ngày '+this.date+'',
       meta: [
         { hid: 'description', name: 'description', content: 'Danh sách công ty thành lập ngày '+this.date+'. Tìm kiếm thông tin công ty, doanh nghiệp, mã số thuế tại Việt Nam' },
